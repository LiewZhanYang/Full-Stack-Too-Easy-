...
function CampDetails() {
  ...
  const skillDevelopmentData = [
    ...
    },
    {
      ...
      description:
        "Develop critical thinking skills to solve challenging problems.",
    },
    {
      title: "Time Management",
      description:
        "Master effective time management for exams and study sessions.",
    },
    {
      title: "Confidence Building",
      description:
        "Boost self-confidence through mock exams and real-time feedback.",
    },
  ];
