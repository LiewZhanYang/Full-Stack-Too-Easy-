  ...
  const skillDevelopmentData = [
    {
      ...
      description:
        "Develop the ability to lead teams effectively, foster collaboration, and drive results.",
    },
    {
      title: "Advanced Communication Skills",
      description:
        "Master professional communication techniques to influence, negotiate, and connect with others.",
    },
    {
      title: "Strategic Problem-Solving",
      description:
        "Learn to analyze complex challenges and implement innovative, data-driven solutions.",
    },
    {
      title: "Career Growth and Personal Branding",
      description:
        "Build a strong professional brand to stand out in your field and accelerate career growth.",
    },
  ];
